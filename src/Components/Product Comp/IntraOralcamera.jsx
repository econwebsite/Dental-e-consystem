            ...
            <div className='mainContainer'>
                <div className='row'>
                    ...
                    <div className='col-lg-8 col-sm-12 productRightSide'>
                        ...
                        Our ODM intraOral camera is engineered to meet the highest standards of dental imaging, combines cutting-edge Full HD imaging with advanced optics to deliver exceptionally clear and detailed images, enabling precise diagnostics and treatment planning. Engineered for superior ergonomics, this intraoral camera ensures a comfortable, user-friendly experience during image acquisition.
                        </p>
