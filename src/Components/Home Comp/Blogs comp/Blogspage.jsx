    ...
    <div className='homeblog-pg'>
      ...
      <div className="homeblog-component-container">
        <div className="homeblog-left-column">
          <div className="homeblog-merged-box" data-aos="zoom-in-right" data-aos-duration="2200" onClick={() => navigate('/Aguidtochoose')} style={{cursor:"pointer"}}>
