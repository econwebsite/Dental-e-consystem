    ...
    <div className='homeblog-pg'>
      ...
      <div className="homeblog-component-container">
        <div className="homeblog-left-column">
          ...
          <Link className="cardImgLink" to="/blogs/choosing-best-dental-intraoral-camera" style={{textDecoration:"none"}}><img src={Capturing} alt="A Guide to Choosing the Right Dental Intraoral Camera" className="homeblog-full-image" /></Link>
        ...
        <div className="homeblog-right-column" data-aos="zoom-in-left" data-aos-duration="1400">
          ...
          <Link className="cardImgLink" to="/blogs/autofocus-vs-fixed-focus-lenses-for-intraoral-cameras" style={{textDecoration:"none"}}><img src={Autofocusvsfixed} alt="Autofocus vs. Fixed focus" className="homeblog-box-image" /></Link>
            <div className="homeblog-box-content">
          ...
          <div className="homeblog-box" style={{cursor:"pointer"}}>
          <Link className="cardImgLink" to="/blogs/choosing-the-right-cmos-cameras-for-extraoral-imaging" style={{textDecoration:"none"}}><img src={CMOS} alt="Choosing the right CMOS cameras" className="homeblog-box-image" /></Link>
            <div className="homeblog-box-content">
