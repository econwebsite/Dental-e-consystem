...
import Balajiimg from "../../assets/Future Blog/Balajiimg (2).jpg"
    ...
    <div className="blogArtical-Total">
      ...
      <div className="Artical-person">
        <div className="Articalleft-side">
          <img src={Balajiimg} alt="Product manager" className="Articalperson-photo" />
          <p>Balaji S</p>
          <p>Product Manager</p>
        </div>
      ...
      <div className="Articalnotification-box">
        ...
        <div className="Articalsubscribe-row">
          ...
          <AnimatedButton className="Articalknow-button" text="Know more" backgroundColor="#003873" animationColor="#69ba2f" hoverColor="#69ba2f" onClick={handelSubscribtion}></AnimatedButton>
